<?php /* Smarty version 2.6.22, created on 2012-03-12 11:28:34
         compiled from file:pages/admin/site_admin_authors.tpl */ ?>
...
<?php endif; ?>
					<table>
						...
						<tbody>
<?php if (count ( $this->_tpl_vars['authors'] ) > 0): ?>
...
?act=admin&sact=authoredit&id=<?php echo $this->_tpl_vars['entry']['id']; ?>
"><?php echo $this->_tpl_vars['entry']['author']; ?>
</a></td>
								<td style="text-align:center"><a href="<?php echo $this->_tpl_vars['script_url']; ?>
?act=admin&sact=authordelete&id=<?php echo $this->_tpl_vars['entry']['id']; ?>
">delete</a></td>
							</tr>
			<?php endforeach; endif; unset($_from); ?>
<?php else: ?>
...
?act=admin&sact=authoradd">Add Author</a></td>
							</tr>
						</tbody>
					</table>
