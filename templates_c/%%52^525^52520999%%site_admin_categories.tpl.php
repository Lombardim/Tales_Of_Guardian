<?php /* Smarty version 2.6.22, created on 2012-03-12 11:28:40
         compiled from file:pages/admin/site_admin_categories.tpl */ ?>
				...
				<div class="art-Post-inner">
				    <div class="art-PostMetadataHeader">
				        <h2 class="art-PostHeaderIcon-wrapper" style="font-size:14px;padding-left:5px;font-weight:bold;">
				            <span class="art-PostHeader">Manage Download-Categories</span>
				        </h2>
				    </div>
...
?act=admin&sact=categoryedit&id=<?php echo $this->_tpl_vars['entry']['id']; ?>
"><?php echo $this->_tpl_vars['entry']['category']; ?>
</a></td>
								<td style="text-align:center"><a href="<?php echo $this->_tpl_vars['script_url']; ?>
?act=admin&sact=categorydelete&id=<?php echo $this->_tpl_vars['entry']['id']; ?>
">delete</a></td>
							</tr>
			<?php endforeach; endif; unset($_from); ?>
<?php else: ?>
...
<?php endif; ?>
							<tr>
								<td colspan="2"><a href="<?php echo $this->_tpl_vars['script_url']; ?>
?act=admin&sact=categoryadd">Add Category</a></td>
							</tr>
						</tbody>
					</table>
				    </div>
